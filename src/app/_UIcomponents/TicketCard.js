...
function TicketCard({ name , position , ImageSRC , links}) {
  return (
    <div className="w-[287px] h-[388px] pl-[12px] pt-[12px] rounded-[20px] bg-[#333333]">
      ...
      <p className="mt-[10px] text-white text-[20px] font-[500]">{name}</p>
      <p className="text-[#FFFFFF80] text-[10px] font-[500] mt-[5px]">{position}</p>
