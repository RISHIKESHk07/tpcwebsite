...
const CustomCarousel = ({ children, showScrollbar }) => {
    ...
    return (
        <div className="relative max-w-full">
            ...
            <div
                ref={carouselRef}
                className="carousel carousel-center max-sm:max-w-[305px] sm:max-w-[305px] md:max-w-[620px] lg:max-w-[920px] space-x-4 p-4 overflow-x-auto scrollbar-hide"
            >
            ...
            {showScrollbar && (
                ...
                >
                    <div className="relative h-2 bg-[#333333] w-full"></div>
                    <img
                        src="/cursor.svg"
                        alt="Scroll Cursor"
