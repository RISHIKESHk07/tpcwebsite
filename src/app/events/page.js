        ...
        <div className="min-h-full w-full mx-auto">
            <main className="bg-[#000]">
                ...
                <div className="px-5 sm:px-32 py-12 w-full">
                    ...
                    <div className="bg-[#1a1a1a] h-[198px] sm:h-[80vh] rounded-[20px] sm:rounded-[40px] relative overflow-hidden border border-white/50">
                        <Image
                            src={"/crlogo.jpg"}
                            fill
                            className="object-cover"
                        />
                        <div className="absolute h-full w-full bg-black/70 hover:opacity-0 hover:scale-150 duration-200 flex">
                            <h1 className="text-7xl m-auto font-extrabold">
                                Coderumble
                            </h1>
                        </div>
                    </div>
                </div>
                <div className="pl-5 sm:pl-32 pr-16 pb-12 w-full relative">
                    <p className="text-white text-2xl sm:text-5xl mb-5 sm:mb-10 w-full">
                        {" "}
                        Past Events
                    </p>
                    <div className="absolute size-24 rounded-full bg-slate-700 z-10 top-1/2 -translate-y-1/2 flex">
                        <Image
                            src={"/left_arrow.svg"}
                            height={200}
                            width={200}
                    ...
                    <div className="absolute size-24 rounded-full bg-slate-700 z-10 top-1/2 right-0 -translate-y-1/2 flex">
                        <Image
                            src={"/right_arrow.svg"}
                            height={200}
                            width={200}
